...
@client.command(pass_context = True , aliases = ["Meme" , "MEME"])
async def meme(ctx):
    embed = discord.Embed(color = ctx.author.color)
    embed.set_footer(text = "Meme generated by Among Us Bot" , icon_url = "https://lh3.googleusercontent.com/VHB9bVB8cTcnqwnu0nJqKYbiutRclnbGxTpwnayKB4vMxZj8pk1220Rg-6oQ68DwAkqO")
...
async def help(ctx):
	...
	helpm.add_field(name = ":one::six: meme -> Generates a random meme from Reddit" , value = "I enjoy those memes a lot!!, so will you")
